...
例2：浙江某木器厂所用木材由江西某林场供应, 现拟在江西某地新建木器厂并由江西林场供应木材后, 浙江某木器厂所用木材只能通过上海进口供应, 影子汇率调整系数为 1.08。木材进口到岸价为 180美元/立方米, 上海离浙江 200 公里。江西林场离浙江 500 公里、距拟建项目 200 公里。木材影子运费为 0.20 元/立方米公里, 贸易费用为货价的 6%。

试计算江西拟建项目耗用木材的影子价格。
$$
\begin{align*}
解：影子价格 &=180\times 8.27\times1.08（货物到岸价）
\\
           &+ (200\times0.20+180\times8.27\times1.08\times6\%) (口岸到浙江厂的运费和贸易费)
\\
           &- (500\times0.20+180\times8.27\times1.08\times6\%) (林场到浙江厂的运费和贸易费)
\\
          &+ (200\times0.20+180\times8.27\times1.08\times6\%)(林场到江西厂的运费和贸易费)
\\
          &= 1684.15(元/立方米)
\end{align*}
$$
...
$$
\begin{align*}
 影子价格 &= FOB(离岸价格)\times 影子汇率  \\ &-  供应厂到口岸的运输费用和贸易费用 \\ &+ 供应厂到项目的运输费用和贸易费用
\end{align*}
$$

例3：上海市某一拟建项目，耗用可供出口的淮南煤矿的原煤，其离岸价格为 40美元/吨。淮南煤矿离口岸 200 公里, 距离上海 500 公里。

求原煤影子价格。

$$
\begin{align*}
解：影子价格 &= 40\times8.27\times1.08
\\
           &- (200\times0.20 + 40\times8.27\times1.08\times6\%) (煤矿到离岸口的运费和贸易费)
\\
    　　　  &+  (500\times0.20 +40\times8.27\times1.08\times6\%) (煤矿到上海的运费和贸易费)
\\
   　　　   &=  417.26（元/吨）
\end{align*}
$$
...
**直接出口产品 (外销产品)**
$$
影子价格 = FOB \times 影子汇率 - 项目到口岸的运输费用和贸易费用
$$

例4：某项目的产出物为出口产品其离岸价为 20 美元/单位, 项目离口岸 200 公里。影子运费为 0.20 元/单位公里, 贸易费用为货价的 6%。

试计算该产出物的影子价格。
$$
\begin{align*}
解：
影子价格 &= (20 \times 8.27 \times 1.08)-(200 \times 0.20)-(20 \times 8.27 \times 1.08 \times 6\%)
\\
　　　      &=  127.91 (元/单位)
\end{align*}
$$
...
例5：某项目所需的某种原材料原由江苏某厂供应, 现在浙江新建某一供应厂并由其供应, 使原江苏某厂增加出口。该原材料离岸价格为 300 美元/吨, 影子运费为 0.20元/吨公里。江苏离口岸 300 公里，江苏离项目所在地 200 公里。浙江离项目所在地 150 公里。 贸易费用为货价的 6%。
...
\\
&- (300×0.20 + 300×8.27×1.08×6\%)(江苏厂到离岸口的运费和贸易费)
\\
&+ (200×0.20 + 300×8.27×1.08×6\%)(江苏厂到某项目地的运费和贸易费)
\\
&- (150×0.20 + 300×8.27×1.08×6\%)(浙江新厂到某项目地的运费和贸易费)
\\
&=   2468.71（元/吨）
...
例6：某厂需进口原材料, 现在某地新建项目生产此种原材料并由新项目供应，其进口到岸价为 100 美元/单位,  影子运费为 0.20 元/单位公里。某厂到口岸的距离为 200 公里, 到新建项目的距离为 100 公里。贸易费用为货价的 6%。

试计算新建项目生产该原材料的影子价格。

$$
\begin{align*}
解：影子价格  &= 100\times8.27 \times 1.08
\\
　　　　　　  &+ (200\times0.20 + 100\times8.27\times1.08\times6\%)(某厂地点到口岸的运费和贸易费)
\\
            &- (100\times0.20 + 100\times8.27\times1.08\times6\%)(某厂地点到新项目地点的运费和贸易费)
\\
            &=   913.16（元/单位）  
\end{align*}
$$
